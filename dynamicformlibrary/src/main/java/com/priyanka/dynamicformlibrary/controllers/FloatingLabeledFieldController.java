...
import com.priyanka.dynamicformlibrary.validations.RequiredFieldValidator;
 ...
 */
public abstract class FloatingLabeledFieldController extends FormElementController {
     ...
     */
    public FloatingLabeledFieldController(Context ctx, String name, String labelText, boolean isRequired) {
     ...
     */
    public FloatingLabeledFieldController(Context ctx, String name, String labelText, Set<InputValidator> validators) {
        super(ctx, name);
    ...
    protected View createView() {
        ...
        View view = inflater.inflate(R.layout.floating_form_labeled_element, null);
