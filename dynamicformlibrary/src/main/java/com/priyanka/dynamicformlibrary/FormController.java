...
import com.priyanka.dynamicformlibrary.controllers.FloatingLabeledFieldController;
import com.priyanka.dynamicformlibrary.controllers.FormSectionController;
import com.priyanka.dynamicformlibrary.controllers.LabeledFieldController;
import com.priyanka.dynamicformlibrary.validations.PerFieldValidationErrorDisplay;
import com.priyanka.dynamicformlibrary.validations.ValidationError;
import com.priyanka.dynamicformlibrary.validations.ValidationErrorDisplay;
    ...
    public List<ValidationError> validateInput() {
        ...
        for (FormSectionController section : getSections()) {
            for (FormElementController element : section.getElements()) {
                ...
                } else if (element instanceof FloatingLabeledFieldController) {
                    FloatingLabeledFieldController field1 = (FloatingLabeledFieldController) element;
                    errors.addAll(field1.validateInput());
                }
            }
        }
